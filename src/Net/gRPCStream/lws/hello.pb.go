...
func init() {
	proto.RegisterType((*String)(nil), "lws.String")
}
...
var fileDescriptor_61ef911816e0a8ce = []byte{
	...
	0xc9, 0xd7, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0xce, 0x29, 0x2f, 0x56, 0x92, 0xe3, 0x62,
	0x0b, 0x2e, 0x29, 0xca, 0xcc, 0x4b, 0x17, 0x12, 0xe1, 0x62, 0x2d, 0x4b, 0xcc, 0x29, 0x4d, 0x95,
	0x60, 0x54, 0x60, 0xd4, 0xe0, 0x0c, 0x82, 0x70, 0x8c, 0xa2, 0xb8, 0x78, 0x3c, 0x40, 0x7a, 0x82,
	0x53, 0x8b, 0xca, 0x32, 0x93, 0x53, 0x85, 0x14, 0xb9, 0x58, 0xc1, 0x7c, 0x21, 0x6e, 0xbd, 0x9c,
	0xf2, 0x62, 0x3d, 0x88, 0x5e, 0x29, 0x64, 0x8e, 0x90, 0x3a, 0x17, 0x7b, 0x72, 0x46, 0x62, 0x5e,
	0x5e, 0x6a, 0x0e, 0x6e, 0x45, 0x1a, 0x8c, 0x06, 0x8c, 0x49, 0x6c, 0x60, 0x77, 0x18, 0x03, 0x02,
	0x00, 0x00, 0xff, 0xff, 0x7a, 0x1d, 0x06, 0x59, 0x96, 0x00, 0x00, 0x00,
}
...
func (c *helloServiceClient) Hello(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
	err := c.cc.Invoke(ctx, "/lws.HelloService/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloServiceClient) Channel(ctx context.Context, opts ...grpc.CallOption) (HelloService_ChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &_HelloService_serviceDesc.Streams[0], "/lws.HelloService/channel", opts...)
	if err != nil {
		return nil, err
	}
...
func _HelloService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lws.HelloService/Hello",
	}
